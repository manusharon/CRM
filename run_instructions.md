...
1. Enable GitHub Pages
   ...
   - Source: Branch = <strong>gh-pages</strong>, Folder = / (root)
   - Save. The site will be available at: https://manusharon.github.io/CRM/ (may take a minute)

2. Run VisaAgent prototype locally
   - cd visa_agent_prototype
   - python -m venv venv
